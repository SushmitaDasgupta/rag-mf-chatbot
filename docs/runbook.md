...
| --- | --- | --- |
| Workflow fails at fetch | 403, timeout, or empty body from source | Check `data/raw/fetch_log.yaml` in the run logs; retry manually; do **not** bypass the URL allowlist |
